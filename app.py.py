...
def initialize_agent(api_key):
    """앱 실행 시 같은 폴더에 있는 규제 파일들을 자동으로 업로드합니다."""
    
    file_paths = [
        "「기구 및 용기·포장의 기준 및 규격」 고시전문(고시 제2026-24호¸ 2026.3.27.)_최종.pdf",
        "[별표 1] 포장재 재질ㆍ색상ㆍ무게 및 재활용의 용이성 기준(포장재 재활용 용이성 등급평가 기준).pdf",
        "「화장품 안전기준 등에 관한 규정」고시 전문.pdf",
        "[별표 1] 사용할 수 없는 원료(화장품 안전기준 등에 관한 규정).pdf", 
        "[별표 1] 제품의 종류별 포장방법에 관한 기준(제4조2항 관련)(제품의 포장재질ㆍ포장방법에 관한 기준 등에 관한 규칙).pdf",
        "[별표 2] 사용상의 제한이 필요한 원료(화장품 안전기준 등에 관한 규정).pdf",
        "[별표 2] 포장재 재질ㆍ색상ㆍ무게 및 재활용의 용이성 판정방법(포장재 재활용 용이성 등급평가 기준).pdf",
        "[별표 3] 인체 세포ㆍ조직 배양액 안전기준(별표 1 관련)(화장품 안전기준 등에 관한 규정).pdf",
        "[별표 4] 유통화장품 안전관리 시험방법(제6조 관련)(화장품 안전기준 등에 관한 규정).pdf"
    ]
    ...
    for path in file_paths:
        if os.path.exists(path):
            ...
            st.warning(f"⚠️ 폴더에 파일이 없습니다. 경로 및 파일명을 확인하세요: {path}")
